...
\begin{itemise}
    ...
    virtuais... Juntas, elas constituem os serviços da computação em nuvem. O \emph{back end}
    possui algumas responsabilidades para cumprir: implementar mecanismos de segurança e
    controle de tráfego, e conectar computadores na rede para comunicação através de
    protocolos (regras fixas e bem definidas).
...
\begin{figure}[ht]
    ...
    \includegraphics[height=0.4\textwidth]{img/frontBackEnd.jpg}
